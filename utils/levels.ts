import { Clef, KeySignature, Knowledge, LevelName, TimeSignature } from "./enums";
import { makeLevelGroup, padZero } from "./helperFns";

import { Level, Scale } from "./types";
...
const TREBLE_PRO_LEVELS = makeLevelGroup({
    ...
    timeSignatures: [TimeSignature["4/4"]],
    levelCount: 24,
    noteRanges: { min: ["c/3", "c/4"], max: ["g/5", "a/6"] },
    scales: [Scale.Diatonic /*Scale.Chromatic*/ /* , Scale.Pentatonic, Scale.Melodic */],
    winConditions: {
...
const GUITAR_LEVELS = makeLevelGroup({
    ...
    timeSignatures: [TimeSignature["4/4"]],
    levelCount: 12,
    noteRanges: { min: ["e/3", "b/3"], max: ["e/5", "g/6"] },
    scales: [Scale.Diatonic /*Scale.Chromatic*/ /* , Scale.Pentatonic, Scale.Melodic */],
    winConditions: {
