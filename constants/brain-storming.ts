...
import { Level, Round, SingleNoteRound, Note, ChordRound, MelodyRound, RhythmRound, NoteRange } from "./types";
...
export function generateRandomNote(level: Level, previousRound?: SingleNoteRound): Note {
